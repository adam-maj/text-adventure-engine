...
TO DO:
    - Make the coordinate max from 9 to 35 by using Base 36 digits (A-Z)
      Edit this in get_adjacent_location function, the __init__ for location
    - Something with the door system
"""
...
class Event(object):
    ...
    def activate(self):
        ...
        for coordinate_tuple in self.description_list:
            locations[str(coordinate_tuple[0]) + str(coordinate_tuple[1]) + str(coordinate_tuple[2])].description = coordinate_tuple[3]
